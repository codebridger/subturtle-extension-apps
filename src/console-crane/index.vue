    ...
    <App>
      <modal v-model="store.isActive" v-slot="{ height, width, close }">
        <div class="flex flex-col" :style="{ width: width + 'px', height: height + 'px' }">
          ...
          <section class="flex items-center gap-2 px-6 py-3 border-b border-gray-100 dark:border-blue-800 shrink-0">
            ...
            <button
              type="button"
              class="text-sm text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-white px-2 py-1 rounded-md hover:bg-gray-100 dark:hover:bg-blue-800 transition-colors"
              @click="goToDashboard"
            >
